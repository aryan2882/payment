...
// const { db } = require('./firebase'); // Import Firebase config
...
const corsOptions = {
  ...
  optionsSuccessStatus: 204  // Ensures successful response for OPTIONS requests
};

app.use(cors(corsOptions)); // Adjust for frontend origin
app.use(express.json());
